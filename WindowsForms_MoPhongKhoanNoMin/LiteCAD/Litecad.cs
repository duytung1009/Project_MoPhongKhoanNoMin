...
public static class Lcad
{
  ...
  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcInitialize", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool Initialize();

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcUninitialize", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool Uninitialize(bool bSaveConfig);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcAddFontRes", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int AddFontRes(int hModule, int idResource, string szFontName);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcAddFontFile", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int AddFontFile(string szFilename, string szFontName);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcAddFontBin", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int AddFontBin(int hData, string szFontName);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcStrAdd", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool StrAdd(string szTag, string szText);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcStrSet", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool StrSet(string szTag, string szText);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcStrGet", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern string StrGet(string szTag);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcStrFileLoad", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool StrFileLoad(string szFileName);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcStrFileSave", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool StrFileSave(string szFileName, string szLanguage, bool bInit);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcPropGetBool", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool PropGetBool(int hObject, int idProp);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcPropGetInt", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int PropGetInt(int hObject, int idProp);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcPropGetFloat", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern double PropGetFloat(int hObject, int idProp);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcPropGetStr", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern string PropGetStr(int hObject, int idProp);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcPropGetStrA", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int PropGetStrA(int hObject, int idProp, out IntPtr szBuf, int BufSize);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcPropGetHandle", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int PropGetHandle(int hObject, int idProp);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcPropPutBool", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool PropPutBool(int hObject, int idProp, bool bValue);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcPropPutInt", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool PropPutInt(int hObject, int idProp, int Value);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcPropPutFloat", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool PropPutFloat(int hObject, int idProp, double Value);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcPropPutStr", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool PropPutStr(int hObject, int idProp, string szValue);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcPropPutHandle", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool PropPutHandle(int hObject, int idProp, int hValue);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcCreateDrawing", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int CreateDrawing();

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcDeleteDrawing", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool DeleteDrawing(int hDrw);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcDrwNew", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool DrwNew(int hDrw, string szFileName, int hLcWnd);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcDrwNewT", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool DrwNewT(int hDrw, string szFileName, string szTemplate, int hLcWnd);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcDrwLoad", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool DrwLoad(int hDrw, string szFileName, IntPtr hWnd, int hLcWnd);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcDrwLoadMem", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool DrwLoadMem(int hDrw, int hMem, int hLcWnd);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcDrwInsert", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool DrwInsert(int hDrw, string szFileName, int Overwrite, IntPtr hWnd);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcDrwSave", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool DrwSave(int hDrw, string szFileName, bool bBak, IntPtr hWnd);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcDrwSaveMem", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int DrwSaveMem(int hDrw, int hMem, int MemSize);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcDrwSaveExploded", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool DrwSaveExploded(int hDrw, string szFileName, bool bBak, IntPtr hWnd);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcDrwPurge", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool DrwPurge(int hDrw);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcDrwRegenViews", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool DrwRegenViews(int hDrw, int hEnt);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcDrwSortObjects", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool DrwSortObjects(int hDrw, int ObjType);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcDrwClearXData", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool DrwClearXData(int hDrw, int ObjType, int Mode);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcDrwResolveBlocks", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool DrwResolveBlocks(int hDrw, out IntPtr szError);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcDrwAddLayer", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int DrwAddLayer(int hDrw, string szName, string szColor, int hLtype, int Lweight);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcDrwAddLinetype", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int DrwAddLinetype(int hDrw, string szName, string szDefinition);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcDrwAddLinetypeF", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int DrwAddLinetypeF(int hDrw, string szName, string szFileName, string szLtypeName);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcDrwAddTextStyle", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int DrwAddTextStyle(int hDrw, string szName, string szFontName);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcDrwAddDimStyle", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int DrwAddDimStyle(int hDrw, string szName);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcDrwAddMlineStyle", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int DrwAddMlineStyle(int hDrw, string szName);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcDrwAddImage", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int DrwAddImage(int hDrw, string szName, string szFileName);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcDrwAddImage2", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int DrwAddImage2(int hDrw, string szName, int Width, int Height, int nBits);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcDrwAddBlock", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int DrwAddBlock(int hDrw, string szName, double X, double Y);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcDrwAddBlockFromFile", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int DrwAddBlockFromFile(int hDrw, string szName, string szFileName, int Overwrite, IntPtr hwParent);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcDrwAddBlockFromDrw", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int DrwAddBlockFromDrw(int hDrw, string szName, int hDrw2, int Overwrite, IntPtr hwParent);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcDrwAddBlockFile", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int DrwAddBlockFile(int hDrw, string szName, string szFileName, int Overwrite, IntPtr hwParent);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcDrwAddViewPaper", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int DrwAddViewPaper(int hDrw, string szName, int PaperSize, int Orient, double Width, double Height);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcDrwDeleteObject", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool DrwDeleteObject(int hDrw, int hObject);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcDrwDeleteUnusedObjects", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int DrwDeleteUnusedObjects(int hDrw, int ObjType);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcDrwGetFirstObject", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int DrwGetFirstObject(int hDrw, int ObjType);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcDrwGetNextObject", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int DrwGetNextObject(int hDrw, int hObject);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcDrwGetObjectByID", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int DrwGetObjectByID(int hDrw, int ObjType, int Id);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcDrwGetObjectByIDH", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int DrwGetObjectByIDH(int hDrw, int ObjType, string szId);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcDrwGetObjectByName", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int DrwGetObjectByName(int hDrw, int ObjType, string szName);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcDrwCountObjects", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int DrwCountObjects(int hDrw, int ObjType);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcDrwGetViewByBlock", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int DrwGetViewByBlock(int hDrw, int hBlock);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcDrwGetEntByID", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int DrwGetEntByID(int hDrw, int Id);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcDrwGetEntByIDH", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int DrwGetEntByIDH(int hDrw, string szId);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcDrwGetEntByKey", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int DrwGetEntByKey(int hDrw, int Key);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcViewSetRect", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool ViewSetRect(int hView, double Xcen, double Ycen, double Width, double Height);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcViewSetRect2", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool ViewSetRect2(int hView, double Lef, double Bot, double Rig, double Top);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcViewSetLimits", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool ViewSetLimits(int hView, double Xmin, double Ymin, double Xmax, double Ymax);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcViewSetGrid", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool ViewSetGrid(int hView, double X0, double Y0, double dX, double dY);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcViewRegen", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool ViewRegen(int hView, int hEnt);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcViewSetPaperSize", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool ViewSetPaperSize(int hView, int PaperSize, int Orient, double Width, double Height);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcViewGetEntByPoint", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int ViewGetEntByPoint(int hView, double X, double Y, double Delta, int Mode);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcViewGetEntsByRect", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int ViewGetEntsByRect(int hView, double Lef, double Bot, double Rig, double Top, bool bCross, int MaxNum);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcViewGetEntity", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int ViewGetEntity(int iEnt);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcViewRasterize", CharSet = CharSet.Unicode, ExactSpelling = true)]
  ...
  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcViewRasterizeMem", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int ViewRasterizeMem(int hView, int hMem, double Lef, double Bot, double Rig, double Top, double Scal);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcViewDrawMarker", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool ViewDrawMarker(int hView, double X, double Y);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcViewDrawLine", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool ViewDrawLine(int hView, double X0, double Y0, double X1, double Y1);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcViewDrawXline", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool ViewDrawXline(int hView, double X0, double Y0, double X1, double Y1, bool bRay);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcViewDrawRect", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool ViewDrawRect(int hView, double X0, double Y0, double X1, double Y1);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcViewPrint", CharSet = CharSet.Unicode, ExactSpelling = true)]
  ...
  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcMLStyleAddLine", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool MLStyleAddLine(int hStyle, double Offset, string szColor, int hLtype);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcMLStyleDelLine", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool MLStyleDelLine(int hStyle, int iLine);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcMLStyleSortLines", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool MLStyleSortLines(int hStyle);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcImageSetPixelRGB", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool ImageSetPixelRGB(int hImage, int X, int Y, int Red, int Green, int Blue);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcImageSetPixelI", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool ImageSetPixelI(int hImage, int X, int Y, int iColor);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcImageGetPixelRGB", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool ImageGetPixelRGB(int hImage, int X, int Y, out int pRed, out int pGreen, out int pBlue);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcImageGetPixelI", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool ImageGetPixelI(int hImage, int X, int Y, out int piColor);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcImageSetPalColor", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool ImageSetPalColor(int hImage, int iColor, int Red, int Green, int Blue);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcImageGetPalColor", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool ImageGetPalColor(int hImage, int iColor, out int pRed, out int pGreen, out int pBlue);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcImageSetTranColor", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool ImageSetTranColor(int hImage, bool bTransparent, int Red, int Green, int Blue);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcImageResize", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool ImageResize(int hImage, int Width, int Height);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcLayerClear", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool LayerClear(int hLayer, int hBlock);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockClear", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool BlockClear(int hBlock, int hLayer);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockPurge", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool BlockPurge(int hBlock);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockSortEnts", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool BlockSortEnts(int hBlock, bool bByLayers);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockAddPoint", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int BlockAddPoint(int hBlock, double X, double Y);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockAddPoint2", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int BlockAddPoint2(int hBlock, double X, double Y, int PtMode, double PtSize);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockAddXline", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int BlockAddXline(int hBlock, double X, double Y, double Angle, bool bRay);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockAddXline2P", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int BlockAddXline2P(int hBlock, double X, double Y, double X2, double Y2, bool bRay);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockAddLine", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int BlockAddLine(int hBlock, double X1, double Y1, double X2, double Y2);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockAddLineDir", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int BlockAddLineDir(int hBlock, double X, double Y, double Angle, double Dist);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockAddLineTan", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int BlockAddLineTan(int hBlock, int hEnt1, int hEnt2, int Mode);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockAddPolyline", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int BlockAddPolyline(int hBlock, int FitType, bool bClosed, bool bFilled);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockAddSpline", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int BlockAddSpline(int hBlock, bool bClosed, bool bFilled);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockAddMline", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int BlockAddMline(int hBlock, int FitType, bool bClosed);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockAddRect", CharSet = CharSet.Unicode, ExactSpelling = true)]
  ...
  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockAddRect2", CharSet = CharSet.Unicode, ExactSpelling = true)]
  ...
  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockAddCircle", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int BlockAddCircle(int hBlock, double X, double Y, double Radius, bool bFilled);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockAddArc", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int BlockAddArc(int hBlock, double X, double Y, double Radius, double StartAngle, double ArcAngle);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockAddArc3P", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int BlockAddArc3P(int hBlock, double X1, double Y1, double X2, double Y2, double X3, double Y3);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockAddEllipse", CharSet = CharSet.Unicode, ExactSpelling = true)]
  ...
  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockAddText", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int BlockAddText(int hBlock, string szText, double X, double Y);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockAddText2", CharSet = CharSet.Unicode, ExactSpelling = true)]
  ...
  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockAddTextWin", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int BlockAddTextWin(int hBlock, string szText, double X, double Y);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockAddTextWin2", CharSet = CharSet.Unicode, ExactSpelling = true)]
  ...
  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockAddMText", CharSet = CharSet.Unicode, ExactSpelling = true)]
  ...
  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockAddArcText", CharSet = CharSet.Unicode, ExactSpelling = true)]
  ...
  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockAddBlockRef", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int BlockAddBlockRef(int hBlock, int hRefBlock, double X, double Y, double Scal, double Angle);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockAddBlockRefID", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int BlockAddBlockRefID(int hBlock, int idRefBlock, double X, double Y, double Scal, double Angle);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockAddBlockRefIDH", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int BlockAddBlockRefIDH(int hBlock, string szIdRefBlock, double X, double Y, double Scal, double Angle);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockAddImageRef", CharSet = CharSet.Unicode, ExactSpelling = true)]
  ...
  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockAddEcw", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int BlockAddEcw(int hBlock, string szFileName);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockAddAttDef", CharSet = CharSet.Unicode, ExactSpelling = true)]
  ...
  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockAddHatch", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int BlockAddHatch(int hBlock, string szFileName, string szPatName, double Scal, double Angle);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockAddViewport", CharSet = CharSet.Unicode, ExactSpelling = true)]
  ...
  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockAddFace", CharSet = CharSet.Unicode, ExactSpelling = true)]
  ...
  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockAddFace4", CharSet = CharSet.Unicode, ExactSpelling = true)]
  ...
  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockAddLeader", CharSet = CharSet.Unicode, ExactSpelling = true)]
  ...
  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockAddDimRot", CharSet = CharSet.Unicode, ExactSpelling = true)]
  ...
  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockAddDimHor", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int BlockAddDimHor(int hBlock, double X0, double Y0, double X1, double Y1, double Yt, string szText);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockAddDimVer", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int BlockAddDimVer(int hBlock, double X0, double Y0, double X1, double Y1, double Xt, string szText);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockAddDimAli", CharSet = CharSet.Unicode, ExactSpelling = true)]
  ...
  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockAddDimAli2", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int BlockAddDimAli2(int hBlock, double X0, double Y0, double X1, double Y1, double Dt, string szText);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockAddDimOrd", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int BlockAddDimOrd(int hBlock, double Xd, double Yd, double Xt, double Yt, bool bX, string szText);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockAddDimRad", CharSet = CharSet.Unicode, ExactSpelling = true)]
  ...
  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockAddDimRad2", CharSet = CharSet.Unicode, ExactSpelling = true)]
  ...
  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockAddDimDia", CharSet = CharSet.Unicode, ExactSpelling = true)]
  ...
  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockAddDimDia2", CharSet = CharSet.Unicode, ExactSpelling = true)]
  ...
  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockAddDimAng", CharSet = CharSet.Unicode, ExactSpelling = true)]
  ...
  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockAddDimAng2", CharSet = CharSet.Unicode, ExactSpelling = true)]
  ...
  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockAddRPlan", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int BlockAddRPlan(int hBlock);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockAddBezier", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int BlockAddBezier(int hBlock, double X1, double Y1, double Angle1, double X2, double Y2, double Angle2);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockAddTIN", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int BlockAddTIN(int hBlock);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockAddClone", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int BlockAddClone(int hBlock, int hEnt);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockGetFirstEnt", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int BlockGetFirstEnt(int hBlock);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockGetNextEnt", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int BlockGetNextEnt(int hBlock, int hEnt);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockGetLastEnt", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int BlockGetLastEnt(int hBlock);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockGetPrevEnt", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int BlockGetPrevEnt(int hBlock, int hEnt);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockGetEntByID", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int BlockGetEntByID(int hBlock, int Id);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockGetEntByIDH", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int BlockGetEntByIDH(int hBlock, string szId);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockGetEntByKey", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int BlockGetEntByKey(int hBlock, int Key);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockGetTIN", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int BlockGetTIN(int hBlock, int Index);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockUnselect", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool BlockUnselect(int hBlock);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockSelectEnt", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool BlockSelectEnt(int hBlock, int hEntity, bool bSelect);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockSelErase", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool BlockSelErase(int hBlock);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockSelMove", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool BlockSelMove(int hBlock, double dX, double dY, bool bCopy, bool bNewSelect);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockSelScale", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool BlockSelScale(int hBlock, double X0, double Y0, double Scal, bool bCopy, bool bNewSelect);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockSelRotate", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool BlockSelRotate(int hBlock, double X0, double Y0, double Angle, bool bCopy, bool bNewSelect);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockSelMirror", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool BlockSelMirror(int hBlock, double X1, double Y1, double X2, double Y2, bool bCopy, bool bNewSelect);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockSelExplode", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool BlockSelExplode(int hBlock);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockSelJoin", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int BlockSelJoin(int hBlock, double Delta);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockGetFirstSel", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int BlockGetFirstSel(int hBlock);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlockGetNextSel", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int BlockGetNextSel(int hBlock);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcEntErase", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool EntErase(int hEnt, bool bErase);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcEntMove", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool EntMove(int hEnt, double dX, double dY);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcEntScale", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool EntScale(int hEnt, double X0, double Y0, double Scal);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcEntRotate", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool EntRotate(int hEnt, double X0, double Y0, double Angle);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcEntMirror", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool EntMirror(int hEnt, double X1, double Y1, double X2, double Y2);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcEntExplode", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool EntExplode(int hEnt, bool bSelect);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcEntOffset", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool EntOffset(int hEnt, double Dist);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcEntToTop", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool EntToTop(int hEnt);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcEntToBottom", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool EntToBottom(int hEnt);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcEntToAbove", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool EntToAbove(int hEnt, int hEnt2);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcEntToUnder", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool EntToUnder(int hEnt, int hEnt2);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcEntGetGrip", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool EntGetGrip(int hEnt, int iGrip, out double pX, out double pY);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcEntPutGrip", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool EntPutGrip(int hEnt, int iGrip, double X, double Y);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcEntUpdate", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool EntUpdate(int hEnt);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcEntCopyBase", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool EntCopyBase(int hEnt, int hEntFrom);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcIntersection", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int Intersection(int hEnt, int hEnt2);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcInterGetPoint", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool InterGetPoint(int iPoint, out double pX, out double pY);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcPlineAddVer", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int PlineAddVer(int hPline, int hVer, double X, double Y);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcPlineAddVer2", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int PlineAddVer2(int hPline, int hVer, double X, double Y, double Param, double W0, double W1);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcPlineAddVerDir", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int PlineAddVerDir(int hPline, int hVer, double Ang, double Length);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcPlineDeleteVer", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool PlineDeleteVer(int hPline, int hVer);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcPlineGetFirstVer", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int PlineGetFirstVer(int hPline);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcPlineGetNextVer", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int PlineGetNextVer(int hPline, int hVer);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcPlineGetLastVer", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int PlineGetLastVer(int hPline);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcPlineGetPrevVer", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int PlineGetPrevVer(int hPline, int hVer);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcPlineGetVer", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int PlineGetVer(int hPline, int Index);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcPlineGetVerPt", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int PlineGetVerPt(int hPline, double X, double Y, double Delta);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcPlineGetSeg", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int PlineGetSeg(int hPline, double X, double Y, double Delta);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcPlineReverse", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool PlineReverse(int hPline);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcPlineSimple", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool PlineSimple(int hPline, bool bSimple, int nLines);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcPlineContainPoint", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int PlineContainPoint(int hPline, double X, double Y);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcPlineGetRoundPrm", CharSet = CharSet.Unicode, ExactSpelling = true)]
  ...
  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcMlineAddVer", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int MlineAddVer(int hMline, int hVer, double X, double Y);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcMlineAddVerDir", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int MlineAddVerDir(int hMline, int hVer, double Ang, double Length);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcMlineDeleteVer", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool MlineDeleteVer(int hMline, int hVer);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcMlineGetFirstVer", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int MlineGetFirstVer(int hMline);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcMlineGetNextVer", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int MlineGetNextVer(int hMline, int hVer);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcMlineGetLastVer", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int MlineGetLastVer(int hMline);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcMlineGetPrevVer", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int MlineGetPrevVer(int hMline, int hVer);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcMlineGetVer", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int MlineGetVer(int hMline, int Index);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcMlineGetVerPt", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int MlineGetVerPt(int hMline, double X, double Y, double Delta);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcMlineGetSeg", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int MlineGetSeg(int hMline, double X, double Y, double Delta);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcMlineReverse", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool MlineReverse(int hMline);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcRPlanAddVer", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int RPlanAddVer(int hRPlan, double X, double Y);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcRPlanSetCurve", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool RPlanSetCurve(int hVer, double Radius, double LenClot1, double LenClot2);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcRPlanSetPos", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool RPlanSetPos(int hVer, double X, double Y);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcRPlanDeleteVer", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool RPlanDeleteVer(int hRPlan, int hVer);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcRPlanGetFirstVer", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int RPlanGetFirstVer(int hRPlan);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcRPlanGetNextVer", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int RPlanGetNextVer(int hRPlan, int hVer);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcRPlanGetLastVer", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int RPlanGetLastVer(int hRPlan);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcRPlanGetPrevVer", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int RPlanGetPrevVer(int hRPlan, int hVer);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcRPlanGetVer", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int RPlanGetVer(int hRPlan, int Index);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcRPlanGetPoint", CharSet = CharSet.Unicode, ExactSpelling = true)]
  ...
  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcRPlanGetDist", CharSet = CharSet.Unicode, ExactSpelling = true)]
  ...
  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcVportSetView", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool VportSetView(int hVport, double Xcen, double Ycen, double Scal, double Angle);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcVportFrolClear", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool VportFrolClear(int hVport);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcVportFrolAdd", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool VportFrolAdd(int hVport, int hLayer);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcVportFrolGet", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int VportFrolGet(int hVport, int iLayer);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcVportIsFrol", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool VportIsFrol(int hVport, int hLayer);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlkRefAddAtt", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int BlkRefAddAtt(int hBlockRef, string szTag, string szValue);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlkRefGetFirstAtt", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int BlkRefGetFirstAtt(int hBlockRef);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlkRefGetNextAtt", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int BlkRefGetNextAtt(int hBlockRef, int hAttrib);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcBlkRefGetAtt", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int BlkRefGetAtt(int hBlockRef, string szTag);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcHatchSetPattern", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool HatchSetPattern(int hHatch, string szFileName, string szPatName, double Scal, double Angle);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcHatchBoundStart", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool HatchBoundStart(int hHatch);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcHatchBoundPoint", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool HatchBoundPoint(int hHatch, double X, double Y);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcHatchBoundEndLoop", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool HatchBoundEndLoop(int hHatch);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcHatchBoundEnd", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool HatchBoundEnd(int hHatch);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcHatchPatStart", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool HatchPatStart(int hHatch);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcHatchPatLine", CharSet = CharSet.Unicode, ExactSpelling = true)]
  ...
  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcHatchPatEnd", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool HatchPatEnd(int hHatch);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcHatchGetLoopSize", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int HatchGetLoopSize(int hHatch, int iLoop);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcHatchGetPoint", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool HatchGetPoint(int hHatch, int iPnt, out double pX, out double pY);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcRectGetPolyline", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int RectGetPolyline(int hRect, out double pX, out double pY, out double pBulge);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcXlinePutDir", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool XlinePutDir(int hXline, double X, double Y);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcTinClear", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool TinClear(int hTin, bool bOnlyTrians);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcTinLoad", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool TinLoad(int hTin, string szFileName, bool bEmbed);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcTinSave", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool TinSave(int hTin, string szFileName, bool bOverwriteExist);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcTinAddPtype", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int TinAddPtype(int hTin, string szName, string szNotes, int Color);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcTinAddPoint", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int TinAddPoint(int hTin, int hPtype, double X, double Y, double Z);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcTinAddTrian", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int TinAddTrian(int hTin, int hPt0, int hPt1, int hPt2);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcTinNormalize", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool TinNormalize(int hTin);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcTinGetZ", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool TinGetZ(int hTin, double X, double Y, out double pZ);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcTinInterLine", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int TinInterLine(int hTin, double X0, double Y0, double X1, double Y1);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcTinInterGetPoint", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool TinInterGetPoint(int hTin, int iPnt, out double pX, out double pY, out double pZ);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcTinDelPtype", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool TinDelPtype(int hTin, int hPtype);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcTinDelPoint", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool TinDelPoint(int hTin, int hPoint);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcTinDelTrian", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool TinDelTrian(int hTin, int hTrian);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcTinPtypeGetFirst", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int TinPtypeGetFirst(int hTin);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcTinPtypeGetNext", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int TinPtypeGetNext(int hTin, int hPtype);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcTinPtypeGetByName", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int TinPtypeGetByName(int hTin, string szName);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcTinPtypeDialog", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool TinPtypeDialog(int hTin, IntPtr hWnd, bool bReadOnly);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcTinPointGetFirst", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int TinPointGetFirst(int hTin);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcTinPointGetNext", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int TinPointGetNext(int hTin, int hPoint);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcTinPointGetByPos", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int TinPointGetByPos(int hTin, double X, double Y, double Delta);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcTinTrianGetFirst", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int TinTrianGetFirst(int hTin);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcTinTrianGetNext", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int TinTrianGetNext(int hTin, int hTrian);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcTinTrianGetByPos", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int TinTrianGetByPos(int hTin, double X, double Y);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcCreateWindow", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int CreateWindow(IntPtr hWndParent, int Style, int Left, int Top, int Width, int Height);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcDeleteWindow", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool DeleteWindow(int hLcWnd);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcWndResize", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool WndResize(int hLcWnd, int Left, int Top, int Width, int Height);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcWndSelectView", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool WndSelectView(int hLcWnd, int hView);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcWndZoomRect", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool WndZoomRect(int hLcWnd, double Left, double Bottom, double Right, double Top);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcWndZoomScale", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool WndZoomScale(int hLcWnd, double Scal);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcWndZoomMove", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool WndZoomMove(int hLcWnd, double DX, double DY);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcWndRedraw", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool WndRedraw(int hLcWnd);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcWndSetFocus", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool WndSetFocus(int hLcWnd);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcWndExeCommand", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool WndExeCommand(int hLcWnd, int Command, int CmdParam);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcWndCoordFromDrw", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool WndCoordFromDrw(int hLcWnd, double Xdrw, double Ydrw, out int pXwin, out int pYwin);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcWndCoordToDrw", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool WndCoordToDrw(int hLcWnd, int Xwin, int Ywin, out double pXdrw, out double pYdrw);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcWndGetCursorCoord", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool WndGetCursorCoord(int hLcWnd, out int pXwin, out int pYwin, out double pXdrw, out double pYdrw);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcWndGetEntByPoint", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int WndGetEntByPoint(int hLcWnd, int Xwin, int Ywin);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcWndSetCmdwin", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool WndSetCmdwin(int hLcWnd, int hCmdLine);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcWndSetPropwin", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool WndSetPropwin(int hLcWnd, int hPropWnd);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcWndStopCommand", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool WndStopCommand(int hLcWnd);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcWndGetPoint", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool WndGetPoint(int hLcWnd, string szPrompt, int SnapMode, int Index, out double pX, out double pY);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcWndGetPointBuf", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool WndGetPointBuf(int hLcWnd, int Index, out double pX, out double pY);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcWndUpdateTabs", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool WndUpdateTabs(int hLcWnd);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcCoordDrwToWnd", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool CoordDrwToWnd(int hLcWnd, double Xdrw, double Ydrw, out int pXwin, out int pYwin);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcCoordWndToDrw", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool CoordWndToDrw(int hLcWnd, int Xwin, int Ywin, out double pXdrw, out double pYdrw);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcColorIsRGB", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool ColorIsRGB(string szColor);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcColorGetRed", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int ColorGetRed(string szColor);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcColorGetGreen", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int ColorGetGreen(string szColor);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcColorGetBlue", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int ColorGetBlue(string szColor);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcColorGetIndex", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int ColorGetIndex(string szColor);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcColorToVal", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool ColorToVal(string szColor, out int pbRGB, out int pIndex, out int pR, out int pG, out int pB);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcColorSetPalette", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool ColorSetPalette(int Index, int R, int G, int B);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcColorGetPalette", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool ColorGetPalette(int Index, out int pR, out int pG, out int pB);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcCreateCmdwin", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int CreateCmdwin(IntPtr hWndParent, int Left, int Top, int Width, int Height);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcCmdwinResize", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool CmdwinResize(int hCmdLine, int Left, int Top, int Width, int Height);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcCmdwinUpdate", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool CmdwinUpdate(int hCmdLine);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcCreatePropwin", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int CreatePropwin(IntPtr hWndParent, int Left, int Top, int Width, int Height);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcPropwinResize", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool PropwinResize(int hPropWnd, int Left, int Top, int Width, int Height);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcPropwinUpdate", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool PropwinUpdate(int hPropWnd, bool bSelChanged);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcGetErrorCode", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int GetErrorCode();

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcGetErrorStr", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern string GetErrorStr();

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcExtractPreview", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int ExtractPreview(string szFileName, int hGlob, int MaxSize);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcExtractFileInfo", CharSet = CharSet.Unicode, ExactSpelling = true)]
  ...
  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcFilletSetLines", CharSet = CharSet.Unicode, ExactSpelling = true)]
  ...
  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcFillet", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool Fillet(double Rad, double Bis, double Tang);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcFilletGetPoint", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool FilletGetPoint(int iPnt, out double pX, out double pY);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcDgGetFileName", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern string DgGetFileName(IntPtr hWnd, int Mode);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcDgGetValue", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern string DgGetValue(IntPtr hWnd, int Lef, int Top, string szTitle, string szPrompt, string szValue);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcDgGetValue2", CharSet = CharSet.Unicode, ExactSpelling = true)]
  ...
  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcPlugGetOption", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern string PlugGetOption(string szFileName, string szKey);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcPlugSetOption", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool PlugSetOption(string szFileName, string szKey, string szValue, bool bSave);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcGetPolarPoint", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern void GetPolarPoint(double X, double Y, double Ang, double Dist, out double pX, out double pY);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcGetClientSize", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool GetClientSize(IntPtr hWnd, out int pWidth, out int pHeight);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcTextOut", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern void TextOut(IntPtr hDC, int x, int y, string szText, int ColorRGB);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcCreateCommand", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int CreateCommand(int hLcWnd, int Id, string szName, bool bNeedSel);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcCmdExit", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool CmdExit();

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcCmdPrompt", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool CmdPrompt(int hCmd, string szText);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcCmdGetEntByPoint", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int CmdGetEntByPoint(int hCmd, int Xwnd, int Ywnd);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcCmdSelectEnt", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool CmdSelectEnt(int hCmd, int hEntity, bool bSelect);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcCmdRedraw", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool CmdRedraw(int hCmd);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcCmdSetFocus", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool CmdSetFocus(int hCmd);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcCmdRegen", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool CmdRegen(int hCmd, int hEnt);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcCmdClearPoints", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool CmdClearPoints(int hCmd);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcCmdAddPoint", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool CmdAddPoint(int hCmd, int Id, double X, double Y);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcCmdGetPoint", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool CmdGetPoint(int hCmd, int Id, out double pX, out double pY);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcCmdSetBasePoint", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool CmdSetBasePoint(int hCmd, bool bEnable, double X, double Y);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcCmdDrawLine", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool CmdDrawLine(int hCmd, double X0, double Y0, double X1, double Y1);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcCmdDrawPickbox", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool CmdDrawPickbox(int hCmd, int Xwnd, int Ywnd);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcCmdEqualPoints", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool CmdEqualPoints(int hCmd, double X0, double Y0, double X1, double Y1, int Delta);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcPaintBegin", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool PaintBegin(int hLcWnd);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcPaintSetPen", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool PaintSetPen(int Style, int Width, int ColorRed, int ColorGreen, int ColorBlue);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcPaintSetBrush", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool PaintSetBrush(int ColorRed, int ColorGreen, int ColorBlue);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcPaintPixel", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool PaintPixel(double X, double Y, int Size, int ColorRed, int ColorGreen, int ColorBlue);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcPaintPoint", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool PaintPoint(double X, double Y, int PtMode, double PtSize);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcPaintLine", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool PaintLine(double X0, double Y0, double X1, double Y1);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcPaintPlineVer", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool PaintPlineVer(double X, double Y);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcPaintPline", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool PaintPline(bool bClosed, bool bFilled, bool bBorder);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcPaintCircle", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool PaintCircle(double X, double Y, double R, bool bFilled, bool bBorder);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcPaintArc", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool PaintArc(double X, double Y, double R, double Ang0, double AngArc);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcPaintSetFont", CharSet = CharSet.Unicode, ExactSpelling = true)]
  ...
  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcPaintSetTextColor", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool PaintSetTextColor(int ColorRed, int ColorGreen, int ColorBlue);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcPaintText", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool PaintText(string szText, double X, double Y, int Align);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcPaintEnd", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool PaintEnd();

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcSurfInitialize", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern void SurfInitialize(int MaxSectPnt, double AngStep);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcSurfUnInitialize", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern void SurfUnInitialize();

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcSurfClearTriangles", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern void SurfClearTriangles();

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcSurfAddTriangle", CharSet = CharSet.Unicode, ExactSpelling = true)]
  ...
  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcSurfGetZ", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool SurfGetZ(double X, double Y, out double pZ);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcSurfGetZ_dbg", CharSet = CharSet.Unicode, ExactSpelling = true)]
  ...
  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcSurfClearPlan", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern void SurfClearPlan();

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcSurfAddPlanVer", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool SurfAddPlanVer(double X, double Y, double Bulge);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcSurfMakeSection", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int SurfMakeSection();

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcSurfGetSectPoint", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool SurfGetSectPoint(int iPnt, out double pX, out double pY, out double pZ);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcCSectClear", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool CSectClear();

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcCSectBegin", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool CSectBegin(int PlineType);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcCSectAddPoint", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool CSectAddPoint(double X, double Y);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcCSectEnd", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool CSectEnd();

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcCSectCalcArea", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern int CSectCalcArea();

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcCSectGetArea", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool CSectGetArea(int iArea, out double pAreaVal, out int pNumPnts);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcCSectGetAreaPoint", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern bool CSectGetAreaPoint(int iArea, int iPnt, out double pX, out double pY);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcEventReturnCode", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern void EventReturnCode(int code);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcEventsEnable", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern void EventsEnable(bool bEnable);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcOnEventMouseMove", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern void OnEventMouseMove(F_MOUSEMOVE pFunc);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcOnEventMouseDown", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern void OnEventMouseDown(F_MOUSEDOWN pFunc);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcOnEventMouseUp", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern void OnEventMouseUp(F_MOUSEUP pFunc);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcOnEventMouseDblClk", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern void OnEventMouseDblClk(F_MOUSEDBLCLK pFunc);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcOnEventMouseSnap", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern void OnEventMouseSnap(F_MOUSESNAP pFunc);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcOnEventMouseLeave", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern void OnEventMouseLeave(F_MOUSELEAVE pFunc);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcOnEventMouseWheel", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern void OnEventMouseWheel(F_MOUSEWHEEL pFunc);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcOnEventKeyDown", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern void OnEventKeyDown(F_KEYDOWN pFunc);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcOnEventPaint", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern void OnEventPaint(F_PAINT pFunc);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcOnEventZoom", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern void OnEventZoom(F_ZOOM pFunc);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcOnEventSelectView", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern void OnEventSelectView(F_SELECTVIEW pFunc);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcOnEventGetPoint", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern void OnEventGetPoint(F_GETPOINT pFunc);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcOnEventAddCommand", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern void OnEventAddCommand(F_ADDCOMMAND pFunc);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcOnEventCmdStart", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern void OnEventCmdStart(F_CMD_START pFunc);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcOnEventCmdFinish", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern void OnEventCmdFinish(F_CMD_FINISH pFunc);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcOnEventCmdMouseDown", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern void OnEventCmdMouseDown(F_CMD_MOUSEDOWN pFunc);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcOnEventCmdMouseUp", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern void OnEventCmdMouseUp(F_CMD_MOUSEUP pFunc);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcOnEventCmdMouseMove", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern void OnEventCmdMouseMove(F_CMD_MOUSEMOVE pFunc);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcOnEventCmdString", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern void OnEventCmdString(F_CMD_STRING pFunc);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcOnEventAddEntity", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern void OnEventAddEntity(F_ADDENTITY pFunc);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcOnEventRegen", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern void OnEventRegen(F_REGEN pFunc);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcOnEventFioProgress", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern void OnEventFioProgress(F_FIOPROGRESS pFunc);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcOnEventSelection", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern void OnEventSelection(F_SELECTION pFunc);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcOnEventPropChanged", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern void OnEventPropChanged(F_PROPCHANGED pFunc);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcOnEventGripSelect", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern void OnEventGripSelect(F_GRIPSELECT pFunc);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcOnEventGripMove", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern void OnEventGripMove(F_GRIPMOVE pFunc);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcOnEventEntErase", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern void OnEventEntErase(F_ENTERASE pFunc);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcOnEventEntMove", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern void OnEventEntMove(F_ENTMOVE pFunc);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcOnEventEntRotate", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern void OnEventEntRotate(F_ENTROTATE pFunc);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcOnEventEntScale", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern void OnEventEntScale(F_ENTSCALE pFunc);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcOnEventEntMirror", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern void OnEventEntMirror(F_ENTMIRROR pFunc);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcOnEventEntProp", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern void OnEventEntProp(F_ENTPROP pFunc);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcOnEventHelp", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern void OnEventHelp(F_HELP pFunc);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcOnEventAddStr", CharSet = CharSet.Unicode, ExactSpelling = true)]
  public static extern void OnEventAddStr(F_ADDSTR pFunc);

  [DllImport("..\\..\\LiteCAD\\litecad.dll", EntryPoint="lcOnEventFontReplace", CharSet = CharSet.Unicode, ExactSpelling = true)]
